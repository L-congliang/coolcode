"""CoolCode CLI entry point and interactive REPL."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="coolcode",
        description="CoolCode — a minimal coding agent",
        add_help=False,
    )
...
Options:
  ...
  --model, -m         Model to use (default: claude-opus-4-6, or COOLCODE_MODEL env)
...
Examples:
  coolcode "fix the bug in src/app.ts"
  coolcode --yolo "run all tests and fix failures"
  coolcode --plan "how would you refactor this?"
  coolcode --max-cost 0.50 --max-turns 20 "implement feature X"
  OPENAI_API_KEY=sk-xxx coolcode --api-base https://aihubmix.com/v1 --model gpt-4o "hello"
  coolcode --resume
  coolcode  # starts interactive REPL
""")
        sys.exit(0)
